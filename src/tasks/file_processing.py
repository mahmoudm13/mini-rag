...
def process_project_files(self, project_id: int, file_id: str, chunk_size: int, 
...
async def _process_project_files(task_instance, project_id: int, file_id: str, chunk_size: int, 
                                    overlap_size: int, do_reset: int):
